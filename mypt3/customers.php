		...
		<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
			...
			<form action="customers.php" method="post" class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input name="cid" type="text" class="form-control" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_id']; else echo $num; ?>" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input name="name" id="name" type="text" placeholder="Product Name" class="form-control" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_name']; ?>" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input name="phone" id="phone" type="text" placeholder="Product Number" class="form-control" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_phone']; ?>"required>
					</div>
				</div>
				...
				<div class="form-group">
					<label for="phone" class="col-sm-3 control-label">Age</label>
					<div class="col-sm-9">
